...
class DashboardCreator:
    ...
    def generate_chart_js(self, chart_id, chart_type, labels, data, dataset_label):
        ...
        return f'''
            ...
            new Chart(ctx, {{
                ...
                options: {{
                    responsive: true,
                    maintainAspectRatio: true, // This is important
                }}
            }});
        '''
    ...
    document.addEventListener('DOMContentLoaded', function() {
        document.querySelectorAll('.resizable-chart').forEach(function(chartContainer) {
            ...
            resizeHandle.addEventListener('mousedown', function(e) {
                ...
                function doDrag(e) {
                    chartContainer.style.width = startWidth + e.clientX - startX + 'px';
                    chartContainer.style.height = startHeight + e.clientY - startY + 'px';
                }
    ...
    """
        ...
        if "load_times" in self.data:
            ...
            html_content += f'<div class="resizable-chart"><h2>Load Times</h2><canvas id="loadTimeChart"></canvas></div>\n'
        ...
        if "database_summary" in self.data:
            ...
            html_content += f'<div class="resizable-chart"><h2>Database Summary</h2><canvas id="summaryChart"></canvas></div>\n'
